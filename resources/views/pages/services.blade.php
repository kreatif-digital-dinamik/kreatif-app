            ...
            <div class="container">
                ...
                <div id="service1" class="service-section my-5 p-4 border rounded bg-white">
                    <div class="row align-items-center">
                        <div class="col-md-5 mb-3 mb-md-0">
                            <img src="{{ asset('/assets/images/new-images/IMG_0091-comp.jpg') }}" alt="{{ __('common.service_1_image_alt') }}" style="width:100%; max-width:350px; height:auto; object-fit:cover;" class="mb-3">
                        </div>
                        <div class="col-md-7">
                ...
                <div id="service2" class="service-section my-5 p-4 border rounded bg-white">
                    <div class="row align-items-center flex-md-row-reverse">
                        <div class="col-md-5 mb-3 mb-md-0">
                            <img src="{{ asset('/assets/images/gallery/untitled-4-2.jpg') }}" alt="{{ __('common.service_2_image_alt') }}" style="width:100%; max-width:350px; height:auto; object-fit:cover;" class="mb-3">
                        </div>
                        <div class="col-md-7">
                ...
                <div id="service3" class="service-section my-5 p-4 border rounded bg-white">
                    <div class="row align-items-center">
                        <div class="col-md-5 mb-3 mb-md-0">
                            <img src="{{ asset('/assets/images/gallery/untitled-1-2.jpg') }}" alt="{{ __('common.service_3_image_alt') }}" style="width:100%; max-width:350px; height:auto; object-fit:cover;" class="mb-3">
                        </div>
                        <div class="col-md-7">
                ...
                <div id="service4" class="service-section my-5 p-4 border rounded bg-white">
                    <div class="row align-items-center flex-md-row-reverse">
                        <div class="col-md-5 mb-3 mb-md-0">
                            <img src="{{ asset('/assets/images/new-images/image-ws2.jpeg') }}" alt="{{ __('common.service_4_image_alt') }}" style="width:100%; max-width:350px; height:auto; object-fit:cover;" class="mb-3">
                        </div>
                        <div class="col-md-7">
                ...
                <div id="service5" class="service-section my-5 p-4 border rounded bg-white">
                    <div class="row align-items-center">
                        <div class="col-md-5 mb-3 mb-md-0">
                            <img src="{{ asset('/assets/images/new-images/image-web-2.png') }}" alt="{{ __('common.service_5_image_alt') }}" style="width:100%; max-width:350px; height:auto; object-fit:cover;" class="mb-3">
                        </div>
                        <div class="col-md-7">
